...
class _SearchAPIState extends State<SearchAPI> {
  ...
  Future<void> fetchData() async {
    ...
    _list.clear();
    final response =
        await http.get(Uri.parse("http://10.4.1.208/myphp/search/search.php"));
                                        ...
                                        text: TextSpan(
                                          ...
                                          children: <TextSpan>[
                                            ...
                                            item.title.contains(controller.text
                                                    .toLowerCase())
                                                ? TextSpan(
                                                    text: item.title.substring(item
                                                            .title
                                                            .indexOf(controller
                                                                .text
                                                                .toLowerCase()) +
                                        ...
                                        text: TextSpan(
                                          ...
                                          children: <TextSpan>[
                                            TextSpan(
                                                ...
                                                style: const TextStyle(
                                                    color: Colors.black)),
                                            item.content.contains(controller.text
                                                    .toLowerCase())
                                                ? TextSpan(
                                                    text: controller.text
                                                        .toLowerCase(),
                                            ...
                                            item.content.contains(controller.text
                                                    .toLowerCase())
                                                ? TextSpan(
                                                    text: item.content.substring(item
                                                            .content
                                                            .indexOf(controller
                                                                .text
                                                                .toLowerCase()) +
...
class Posts {
  ...
  factory Posts.formJson(Map<String, dynamic> json) {
    return Posts(
      ...
      content: json['content'].toLowerCase(),
    );
  }
}
